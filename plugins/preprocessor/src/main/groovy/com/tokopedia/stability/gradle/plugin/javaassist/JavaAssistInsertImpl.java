package com.tokopedia.stability.gradle.plugin.javaassist;
...
//        }.get()
    ...
    //Determine if there is a method call in the code
    private boolean isCallMethod = false;

    /**
     * Determine if there is a method call
     *
     * @return Whether to instrument
     */
...
//            public void edit(NewExpr e) throws CannotCompileException { isCallMethod = true; }
    ...
    /**
     * Judging the method to call PathProxy according to the incoming type
     *
     * @param type return type
     * @param isStatic is a static method
     * @param methodId method number
