...
import com.tokopedia.stability.utils.ZipUsingJavaUtil
...
class RobustAction implements Action<Project> {
    ...
    void execute(Project project) {
        def workingDir = "${project.rootProject.buildDir.path}/${Constants.STABILITY_GENERATE_DIRECTORY}/tmp"
        def outputDir = "${project.rootProject.buildDir.path}/${Constants.STABILITY_GENERATE_DIRECTORY}"
