...
class Patch extends Transform implements Plugin<Project> {
    ...
    def initConfig(Project project) {
        ...
        Config.robustGenerateDirectory = "${project.buildDir}" + File.separator + "$Constants.STABILITY_GENERATE_DIRECTORY" + File.separator;
...
//            }
    ...
    def autoPatch(Project project, List<CtClass> box) {
        ...
        String patchPath = buildDir.getAbsolutePath() + File.separator + Constants.STABILITY_GENERATE_DIRECTORY + File.separator;
